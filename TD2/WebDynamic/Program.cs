...
namespace WebDynamic
{
    class Program
    {
        private static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                /*if(request.Url.Segments[request.Url.Segments.Length-1].Contains("mymethod"))
                {
                    Type type = typeof(MyMethod);
                    MethodInfo method = type.GetMethod("mymethod");
                    MyMethod methods = new MyMethod();
                    string[] param = new string[] {param1,param2};
                    content = (string)method.Invoke(methods, param);
                }*/
                ...
                {
                    Console.WriteLine(methodName + " does not exist");
                }
    ...
    public class MyMethod
    {
        ...
        public string exo5(string param1, string param2)
        {
            ProcessStartInfo start = new ProcessStartInfo();
            start.FileName = "../../../Exo5/bin/Debug/Exo5.exe";
