    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(!debug)
            {
                ...
                Console.WriteLine("Quelle est votre adresse de départ ? (sans le code postal et la ville)");
                start = Console.ReadLine();
                Console.WriteLine("Quelle est votre adresse de destination ? (sans le code postal et la ville)");
